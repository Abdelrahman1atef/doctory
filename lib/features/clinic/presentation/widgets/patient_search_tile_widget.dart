          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  Text(
                    patient.name,
                    style:
                        AppStyles.s14SemiBold.withColor(AppColors.textPrimary),
                  ),
                  const SizedBox(height: 2),
                  Text(
                    '${'phone'.tr()}: ${patient.phone}',
                    style:
                        AppStyles.s12Medium.withColor(AppColors.textSecondary),
                  ),
                ],
              ),
            ),
            Column(
              ...
              children: [
                ...
                Text(
                  '${LocaleKeys.last_visit.tr()}: ${patient.lastVisit}',
